...
pub struct Cli {
    /// Hive root (must contain `.odm/odm.config.yaml`). No upward walk.
...
pub fn resolve_wt_from_env() -> Result<Option<String>, HiveError> {
...
pub enum Commands {
    ...
    Generate {
        ...
        name: Option<String>,
        /// Destination path relative to Hive root (required with name).
