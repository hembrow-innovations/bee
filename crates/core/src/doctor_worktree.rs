...
pub(crate) fn worktree_checks<R: hive_git::CommandRunner>(
    git: &Git<R>,
    ws: &Hive,
) -> Vec<DoctorCheck> {
...
#[allow(dead_code)]
pub(crate) fn worktree_orphan_checks<R: hive_git::CommandRunner>(
    git: &Git<R>,
    ws: &Hive,
) -> Vec<DoctorCheck> {
    let mut checks = Vec::new();
...
/// Prefer [`worktree_checks`] in doctor so orphan+dirty share one sample.
#[allow(dead_code)]
pub(crate) fn worktree_dirty_checks<R: hive_git::CommandRunner>(
    git: &Git<R>,
    ws: &Hive,
) -> Vec<DoctorCheck> {
    let mut checks = Vec::new();
