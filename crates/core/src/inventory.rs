//! Hive inventory sample — worktree slots/orphans.
...
pub fn observe_project_worktrees<R: hive_git::CommandRunner>(
    git: &Git<R>,
    ws: &Hive,
    project: &str,
) -> Result<ProjectWorktreeInventory, HiveError> {
...
pub fn observe_project_worktrees_soft<R: hive_git::CommandRunner>(
    git: &Git<R>,
    ws: &Hive,
    project: &str,
...
pub fn observe_worktree_registered_names<R: hive_git::CommandRunner>(
    git: &Git<R>,
    ws: &Hive,
    project: &str,
...
mod tests {
    ...
    use hive_git::{CommandOutput, CommandRunner};
    ...
    fn ws_with_project(root: PathBuf, name: &str, rel: &str) -> Hive {
